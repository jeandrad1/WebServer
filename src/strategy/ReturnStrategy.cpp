...
static bool	isValidCode(std::string const &value)
{
...
static bool	oneParameterCase(std::string const &arg)
{
	if (isValidCode(arg) == true && (arg[0] == '4' || arg[0] == '5' || arg == "200" || arg == "204"))
		return (true);
...
static bool	twoParameterCase(std::string const &code, std::string const &direction)
{
